...
<div class="delete-container"><div class="delete-container">
    <!-- Título -->
    <h1 class="title">Eliminar Empleado</h1>

    <!-- Alerta de Confirmación -->
    <div class="alert-box">
        <i class="icon-warning"></i>
        <p>
            ¿Estás seguro de que quieres eliminar al empleado <strong>{{ $employee->name_e }} {{ $employee->surnames_e }}</strong>? <br>
    ...
    <div class="button-container">
        ...
        <form action="{{ route('employees.destroy', $employee->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que quieres eliminar este empleado?');">
            @method('DELETE')
            @csrf
